...
import { emaranhamento } from "./iniciante/emaranhamento";
import { medicao } from "./iniciante/medicao";
import { portas } from "./iniciante/portas";
import { primeiroCircuito } from "./iniciante/primeiro-circuito";
 ...
 */
export const lessons: Lesson[] = [...bitsEQubits, ...superposicao, ...medicao, ...portas, ...emaranhamento, ...primeiroCircuito];
